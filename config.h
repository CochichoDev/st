...
static char *font2[] = {"Fira Mono:pixelsize=18:antialias=true:autohint=true","Noto Color Emoji:pixelsize=18:antialias=true:autohint=true"};
...
//
//	/* Specific background color palette */
//	"#f9e8fb", 
//	"#debdf3", 
//	"#c088f7", 
//	"#7083ea", 
...
unsigned int defaultcs = 256;
static unsigned int defaultrcs = 257;
unsigned int bg = 267, bgUnfocused = 267;
*/
/*
